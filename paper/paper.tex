...
Figure~\ref{fig:performance_across_ta} demonstrates how well our primary model in this study, RDG, ranks TD pairs by comparison to a composite score from Open Targets, OTS. The relative risk (RR) metric used in this comparison as well as all others where not specified otherwise is defined as:
...
\input{assets/features_table.tex}
